    ...
    return (
      <div className="container mx-auto py-12 text-center">
        <div className="bg-white rounded-lg shadow-sm p-8 max-w-2xl mx-auto">
          ...
          <p className="text-gray-600">সংবাদ লোড হচ্ছে...</p>
        </div>
      </div>
    );
  }

  if (error || !sidebarNews || sidebarNews.length === 0) {
    return (
      <div className="container mx-auto py-12 text-center">
        <div className="bg-white rounded-lg shadow-sm p-8 max-w-2xl mx-auto">
          <svg
          ...
          <h3 className="text-xl font-semibold text-gray-800 mb-2">কোন ভিডিও পাওয়া যায়নি</h3>
          <p className="text-gray-600">এই মুহূর্তে কোন ভিডিও উপলব্ধ নেই। অনুগ্রহ করে কিছুক্ষণ পর আবার চেষ্টা করুন।</p>
        </div>
      </div>
    );
  }
